...
--
-- Host: localhost
-- Generation Time: Apr 16, 2020 at 06:55 PM
...
-- Database: `khanslist`
--
CREATE DATABASE IF NOT EXISTS `khanslist` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `khanslist`;
...
(42, 2, 5, '<iframe src=\"http://10.0.100.100:8000/index.html\"></iframe>', 1);
...
CREATE TABLE `users` (
  ...
  `safe_ip` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `users` (`id`, `email`, `password`, `admin`, `safe_ip`) VALUES
(1, 'admin@local.local', '$2b$12$bZlSzzm0mb.gtKQk0Q8v6u5w.VZP7qrG.CSpku5ASNxspfc2wowgG', 1, '127.0.0.1'),
(2, 'bob@aol.com', '$2y$10$yBtSeF5w0h1gzGTDxLbDAedN/m4m1V7DL6JXB6mcNPEMapyytFXfC', 0, NULL),
(3, 'bob@aol.coms', '$2y$10$5ex/lx.CmwzgY3Ff6dZn1ODOXvVJqjL.sJEhhklGhz2DW8q7BeJIm', 0, NULL);
